...
// GetVerifyTasks calls the "get_verify_tasks" endpoint of the "moltservice"
// service.
func (c *Client) GetVerifyTasks(ctx context.Context) (res []*VerifyRun, err error) {
	var ires any
	ires, err = c.GetVerifyTasksEndpoint(ctx, nil)
	if err != nil {
		return
	}
